...
# It takes a study (or a list of studies) and obtains study metadata
...
def generate_yaml(study, template, output, db, download_path, 
    ...
    study_query = 'SELECT "metadata_study"."id", "metadata_study"."creation_date",'\
                  '"metadata_study"."notes", "metadata_study"."metadata_checked", "metadata_study"."modifier",'\
                  '"metadata_study"."geo_accession", "metadata_study"."study_accession", "metadata_study"."study_title",'\
                  '"metadata_study"."study_type", "metadata_study"."study_abstract", "metadata_study"."study_description",'\
                  '"metadata_study"."xref_link", "metadata_study"."submission_accession", "metadata_study"."sradb_updated",'\
                  '"metadata_study"."soft_deleted" FROM "metadata_study" WHERE "metadata_study"."geo_accession" = "{study_gse}"'.\
    ...
    exp_query = '''SELECT "metadata_experiment"."id", "metadata_experiment"."creation_date", "metadata_experiment"."notes", "metadata_experiment"."metadata_checked",\
                "metadata_experiment"."modifier", "metadata_experiment"."study_id", "metadata_experiment"."matched_experiment_id", "metadata_experiment"."experiment_alias",\
                "metadata_experiment"."experiment_accession", "metadata_experiment"."type", "metadata_experiment"."title", "metadata_experiment"."study_name",\
                "metadata_experiment"."design_description", "metadata_experiment"."sample_accession", "metadata_experiment"."sample_attribute", "metadata_experiment"."library_strategy",\
                "metadata_experiment"."library_layout", "metadata_experiment"."library_construction_protocol", "metadata_experiment"."platform", "metadata_experiment"."platform_parameters",\
                "metadata_experiment"."xref_link", "metadata_experiment"."experiment_attribute", "metadata_experiment"."submission_accession", "metadata_experiment"."sradb_updated",\
                "metadata_experiment"."organism", "metadata_experiment"."cell_line", "metadata_experiment"."group", "metadata_experiment"."threep_adapter", "metadata_experiment"."fivep_adapter",\
                "metadata_experiment"."threep_umi_length", "metadata_experiment"."fivep_umi_length", "metadata_experiment"."read_length", "metadata_experiment"."is_paired_end", "metadata_experiment"."experiment_file"
                FROM "metadata_experiment" WHERE "metadata_experiment"."study_id" = {id}'''\
                    .format(id = study_id)
    ...
    for cur_gsm in ribo_dict:
        ...
        srr_query = 'SELECT "metadata_srr"."id", "metadata_srr"."experiment_id",\
                    "metadata_srr"."sra_accession", "metadata_srr"."creation_date" FROM "metadata_srr"\
                    WHERE "metadata_srr"."experiment_id" = {id}'.\
